          ...
          <div className="landing-page">
            <div className="main-content">
              ...
              <div className="welcome_message">
                <h1>Welcome to the AMU Support Center</h1>
                <p>
                  In order to streamline support requests and better serve you,
                  we utilize a support ticket system. For your reference, we
                  provide complete archives and a history of all your support
                  requests.
