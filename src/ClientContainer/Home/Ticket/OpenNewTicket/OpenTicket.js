  ...
  const onSubmit = async (event) => {
    ...
    files.forEach((file) => {
      ...
      if (file.type !== allowedType) {
        showError(
          `File ${file.name} has an invalid file type. Allowed type: PDF.`
        );
        isValid = false;
        return;
      }
            ...
            <Box sx={{ boxShadow: 3, p: 4, width: "70%" }}>
              <div className="container all-container">
                ...
                <Typography variant="h3">
                  Please fill out this form to submit your Issue.
                </Typography>
                ...
                <FormControl sx={{ width: 600, maxWidth: "100%", mt: 2 }}>
                  ...
                  >
                    ...
                    <option value="transferRequest">
                      Student transfer request
                    </option>
                    <option value="transferRequest">
                      Teacher transfer request
                    </option>
                    <option value="scholarshipRequest">
                      Scholarship Question
                    </option>
                    <option value="studyAbroadRequest">
                      Request to return to work after studying abroad
                    </option>
                    <option value="complaintRequest">
                ...
                <Box sx={{ width: 600, maxWidth: "100%", mt: 2 }}>
                  <TextField
                    ...
                    onChange={(e) =>
                      setValue({ ...value, issueDescription: e.target.value })
                    }
                  />
                </Box>
                <Stack
